package com.yonghui.platform.usercenter;
...
public class GenerateCode {
    public static void main(String[] args) throws Exception {
        ...
        mpg.setGlobalConfig(new GlobalConfig()
                // 覆盖输出到xxx目录
                .setFileOverride(true).setOutputDir(System.getProperty("user.dir") + "//yonghui-platform-usercenter-dao//src//main//java//")
//                .setFileOverride(true).setOutputDir("D://wly")
        ...
        mpg.setPackageInfo(new PackageConfig()
                // 父包名 模块名
                .setParent("com.yonghui.platform").setModuleName("usercenter")
                // 分层包名
